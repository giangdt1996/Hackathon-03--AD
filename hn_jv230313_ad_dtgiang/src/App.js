...
function App() {
  const [products, setProducts] = useState([
    {
      ...
      qty: 10,
      heading: "Wireless Noise Cancelling Earphones.Lets Try ",
    ...
    },
    {
      ...
      qty: 15,
      heading: "You’ve never seen a watch like this, Lets Try",
    ...
    },
    {
      ...
      qty: 20,
      heading: "The best for the smartest personal computer",
  ...
  const totalAmount = cart.reduce(
    (countProduct, product) => countProduct + product.amount,
    0
  );

  return (
    <div className="App">
      <button className="cart-icon" onClick={handleChangeDisplay}>
      ...
      <Card
        ...
        setCart={setCart}
      />
      <div className={!display ? "onDisplay" : "offDisplay"}>
